...
public class WhilelangParser extends Parser {
	...
	public static final int
		...
		RULE_whileDoLoop = 4, RULE_condition = 5, RULE_comparisonOperator = 6, 
		RULE_expression = 7, RULE_print = 8, RULE_term = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "assignment", "loop", "whileDoLoop", "condition", 
			"comparisonOperator", "expression", "print", "term"
		};
	}
	...
	public final WhileDoLoopContext whileDoLoop() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_whileDoLoop);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(48);
